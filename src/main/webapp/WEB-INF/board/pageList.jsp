...
<h2 style="padding: 25px;">일반 게시판</h2>
...
<table class="table">
<thead><tr><th>글번호</th><th>제목</th><th>글쓴이</th><th>작성일자</th><th>조회수</th></tr></thead>
<tbody>
...
<td style="text-align: left;"><c:forEach begin="1" end="${board.depth}">
<img src="/img/reply_icon.gif" style="width:42px; height=15px">
</c:forEach>
${board.title}<c:if test="${not empty board.filename}">&nbsp;&nbsp;
<a href="/file/uploadFold/${board.filename}" download>
<img src="/img/file.png" style="width: 20px; height: 20px" onclick="event.cancelBubble=true">
</a></c:if></td>
...
<tr onclick="event.cancelBubble=true"><td></td><td>글이 삭제되었습니다.</td><td></td><td></td></tr>
</c:if>
</c:forEach>
</tbody>
</table>
